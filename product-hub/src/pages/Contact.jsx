    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {submitted ? (
        <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-green-700 mb-2">Message Sent!</h2>
          <p className="text-green-600 text-sm">Thank you for reaching out. We'll get back to you soon.</p>
          <button
            onClick={() => setSubmitted(false)}
            className="mt-6 bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-xl text-sm font-medium transition-colors"
          >
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white py-3 px-6 rounded-xl font-semibold text-sm transition-colors"
            >
              Send Message
            </button>
          </div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-8">
        {[
          { icon: <img className="size-8" src="https://www.svgrepo.com/show/502648/email.svg" alt="Email" />, label: 'Email', value: 'hello@producthub.com' },
          { icon: <img className="size-8" src="https://www.svgrepo.com/show/522677/telephone.svg" alt="Phone" />, label: 'Phone', value: '+92 3009777344' },
          { icon: <img className="size-8" src="https://www.svgrepo.com/show/532540/location-pin-alt-1.svg" alt="Location" />, label: 'Location', value: 'Islamabad, Pakistan' },
        ].map((item) => (
